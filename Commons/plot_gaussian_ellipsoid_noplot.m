function [xp,yp,zp] = plot_gaussian_ellipsoid_noplot(m, C, sdwidth, npts, axh)
...
switch numel(m)
   ...
   case 3, [xp,yp,zp]=show3d(m(:),C,sdwidth,npts,axh);
   otherwise
...
%-----------------------------
function [xp,yp,zp] = show3d(means, C, sdwidth, npts, axh)
