...
def bs_probability_scenarios(**kwargs):
    ...
    for i in random_value:
        ...
        if(abs(prob_scenes['par_scenarios_bs'][idx,0]-46.0)+abs(prob_scenes['par_scenarios_bs'][idx,1]-7.07)+abs(prob_scenes['par_scenarios_bs'][idx,2]-3.71)+abs(prob_scenes['par_scenarios_bs'][idx,3]-37.38)+abs(prob_scenes['par_scenarios_bs'][idx,4]-1.0)+abs(prob_scenes['par_scenarios_bs'][idx,5]-22.5))<0.01:
           print(prob_scenes['par_scenarios_bs'][idx,:])    
           print(idx)
