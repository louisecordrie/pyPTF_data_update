...
def bs_probability_scenarios(**kwargs):
    ...
    if(prob_scenes['BScomputedYN'] == False or short_term['BS_computed_YN'] == False or pre_selection['BS_scenarios'] == False):
        ...
        print(prob_scenes['BScomputedYN'],short_term['BS_computed_YN'],pre_selection['BS_scenarios'])  
        ...
        for i2 in range(bs2_pos):
            ...
            for i3 in range(len_depth_valvec):
                ...
                for i4 in range(foc_ids):
                    ...
                    # Modification Louise Test Prior
                    # prob_scenes['prob_scenarios_bs_fact'][iScenBS][4] = 1.0/len(tmpProbAngles)
...
def set_if_compute_scenarios(**kwargs):
    ...
    print('Negligible: ', short_term['magnitude_probability'], short_term['RatioBSonTot'])
    print(tmpbs)
